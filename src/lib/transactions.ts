...
export const parysAllowedTransactionKeys: { [key: string]: boolean } = {
  chainId: true,
  data: true,
  gasLimit: true,
  gasPrice: true,
...
export function serializePARYSTransaction(
  transaction: any,
...
// Need to override to use the parys tx prop whitelists above
export function parsePARYSTransaction(
